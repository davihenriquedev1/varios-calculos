...
import { fetchExchangeRate, useExchangeRate } from "@/hooks/useExchangeRate";
...
type Props = {initialData:ExchangeRate}
...
const Page = ({initialData}:Props) => {
    ...
    const { data, error, isLoading } = useExchangeRate(initialData);
