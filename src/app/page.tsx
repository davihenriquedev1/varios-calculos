		...
		<main className="flex flex-col w-full items-center justify-center">
			...
			<section className="flex flex-col w-full py-10 justify-between bg-gray-500/5 md:flex-row gap-1  md:py-14">
				<div className="flex justify-start h-full p-4 md:flex-1 ">
					<div className="text-5xl text-color-palette2 font-bold text-shadow-bottom-left shadow-color-palette4 sm:text-8xl md:p-5">
						<p>Calcule,</p>
						<p>Simule,</p>
						<p>Resolva.</p>
					</div>
			...
			<section className="flex flex-col w-full px-4 py-10 gap-8 md:px-10 md:py-14 bg-gradient-to-t from-color-palette1/5 to-gray-500/5">
				...
				<div className="flex w-full justify-center items-center ">
					<h2 className="font-extrabold tracking-wide text-center text-4xl md:text-6xl text-color-palette2 text-shadow-bottom-left shadow-color-palette4">Múltiplas Calculadoras</h2>
				</div>
