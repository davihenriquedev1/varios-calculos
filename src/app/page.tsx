...
const Home = () => {
	return (
		<main className="flex flex-col w-full items-center justify-center">
			...
			<section className="flex flex-col w-full px-4 py-10 gap-8 md:px-10 md:py-14 lg:h-screen bg-gradient-to-t from-color-palette1/5 to-gray-500/5">
				
				<div className="flex w-full md:justify-center md:items-center ">
					<h2 className="font-extrabold tracking-wide md:text-center text-4xl md:text-6xl text-color-palette2">Múltiplas Calculadoras</h2>
				</div>
			...
			<section className="flex flex-col w-full px-4 py-10 gap-8 md:px-10 md:py-14 md:h-screen bg-gradient-to-b from-color-palette1/5 to-color-palette1/50">
